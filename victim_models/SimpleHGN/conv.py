...
class myGATConv(nn.Module):
    ...
    def __init__(self,
        ...
        self._num_heads = num_heads # Attention heads
        self._in_src_feats, self._in_dst_feats = expand_as_pair(in_feats)
        self._out_feats = out_feats # out feature
        ...
        if isinstance(in_feats, tuple):
            ...
            self.fc = nn.Linear(
                self._in_src_feats, out_feats * num_heads, bias=False) #64* （64*8）
        self.fc_e = nn.Linear(edge_feats, edge_feats*num_heads, bias=False)# 64* 512
